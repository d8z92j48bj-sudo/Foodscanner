...
import { Info, Snowflake, Calendar, Flame, Sparkles, ChefHat, Lightbulb } from 'lucide-react';
...
const ProductCard: React.FC<ProductCardProps> = ({ product, aiData, isAiLoading }) => {
  return (
                ...
                <div className="space-y-4">
                     <div className="bg-indigo-50 rounded-xl p-5 border border-indigo-100 relative overflow-hidden">
                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                <h4 className="font-bold text-indigo-900 text-sm mb-1">Smart Tip</h4>
